...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _jsDirectory 		= (config.jsDirectory!=null?config.jsDirectory:"skins/js/flexpaper/js/");
    _cssDirectory 		= (config.cssDirectory!=null?config.cssDirectory:"skins/js/flexpaper/css/");
